  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <div className="px-6 py-6 border-b border-border flex items-center justify-between">
        <Link href="/weight" className="p-2 -ml-2 text-foreground bg-muted rounded-xl hover:bg-muted/80 transition-colors">
          <ArrowLeft size={24} />
        </Link>
      ...
      <div className="flex-1 p-6 space-y-8 pt-12">
        <form id="log-form" action={logWeight} className="space-y-6">
